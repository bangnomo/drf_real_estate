...
class UserSerializer(serializers.ModelSerializer):
    ...
    )  # Lay field gender tu profile, vi quan he cua profile va user la OneToOne
    ...
    )  # get_full_name la property cua User duoc tao ra trong models.py
...
class CreateUserSerializer(serializers.ModelSerializer):
    ...
    ):  # su dung Meta tu class UserCreateSerializer cua Djoser
        model = User
