...
class Profile(TimeStampedUUIDModel):
    ...
    phone_number = PhoneNumberField(verbose_name=_("Phone Number"), max_length=30, default="+84987654321")
    ...
    profile_photo = models.ImageField(verbose_name=_("Photo profile"), default="/profile_default.png")
    gender = models.CharField(choices=Gender.choices, verbose_name=_("Gender"), default=Gender.OTHER, max_length=20)
    country = CountryField(verbose_name=_("Country"), default="VN", blank=False, null=False)
    city = models.CharField(verbose_name=_("City"), max_length=180, default="Ho Chi Minh", blank=False, null=False)
    ...
    def __str__(self):
        return f"{self.user.username} {self.gender} {self.country}"
